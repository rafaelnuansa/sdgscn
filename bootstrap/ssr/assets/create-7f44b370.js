...
function Form({ auth, page_meta, page_data }) {
  ...
  const { data, setData, post, errors, processing } = useForm({
    image: null,
    name: ((_a = page_data.hotel) == null ? void 0 : _a.name) ?? "",
    location: ((_b = page_data.hotel) == null ? void 0 : _b.location) ?? "",
    stars: ((_c = page_data.hotel) == null ? void 0 : _c.stars) ?? "",
    description: ((_d = page_data.hotel) == null ? void 0 : _d.description) ?? "",
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsx(Input, { name: "location", onChange, value: data.location }),
          /* @__PURE__ */ jsx(InputErrorMessage, { message: errors.location })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx(Label, { children: "Stars / Rate" }),
          /* @__PURE__ */ jsx(Input, { name: "stars", placeholder: "1-5", type: "number", onChange, value: data.stars }),
          /* @__PURE__ */ jsx(InputErrorMessage, { message: errors.stars })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
