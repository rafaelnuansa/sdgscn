...
function ResearchCreate({ sdgs, experts = [] }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Research" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Create Research" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Create a new research entry" })
      ] }),
...
ResearchCreate.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  ResearchCreate as default
};
