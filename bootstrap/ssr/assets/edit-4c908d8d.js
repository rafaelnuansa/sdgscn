...
function PublicationEdit({ publication, sdgs, experts }) {
  const { data, setData, post, errors, processing } = useForm({
    sdg_id: publication.sdg_id ?? "",
    title: publication.title ?? "",
    year: publication.year ?? "",
    link: publication.link ?? "",
    experts: publication.experts.map((expert) => expert.id) ?? [],
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route("admin.publications.update", publication.id), data);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Publication" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Edit Publication" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Edit the existing publication entry" })
      ] }),
...
PublicationEdit.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  PublicationEdit as default
};
