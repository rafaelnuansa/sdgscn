...
function ResearchIndex({ researches, sdgs, filters }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Researches" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-0  [&_thead]:border-t", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: researches.data.map((research) => /* @__PURE__ */ jsxs(TableRow, { children: [
          /* @__PURE__ */ jsxs(TableCell, { className: "overflow-hidden", children: [
            /* @__PURE__ */ jsx("b", { className: "line-clamp-2", children: research.title }),
            research.experts && research.experts.length > 0 ? research.experts.map((expert) => expert.name).join(", ") : "",
      ...
      /* @__PURE__ */ jsx(CardFooter, { className: "border-t text-sm text-muted-foreground", children: /* @__PURE__ */ jsx(Pagination, { links: researches.links }) })
    ] }) })
  ] });
}
