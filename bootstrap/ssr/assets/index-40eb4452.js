...
import VendorTable from "./table-ced052fc.js";
...
function VendorIndex() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Vendors" }),
    /* @__PURE__ */ jsxs(Container, { children: [
      /* @__PURE__ */ jsx(Header, { title: "Vendors", subtitle: "Manage vendors" }),
      /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:px-6 lg:p-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-8 flex items-center justify-between", children: [
          /* @__PURE__ */ jsx(Search, { URL: route("admin.vendors.index") }),
          /* @__PURE__ */ jsx(Link, { href: route("admin.vendors.create"), className: buttonVariants({ variant: "default" }), children: "Create Vendor" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold", children: "Vendors" }),
          /* @__PURE__ */ jsx(VendorTable, { vendors }),
          /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(Pagination, { links: vendors.links }) })
        ] })
      ] })
    ] })
  ] });
}
VendorIndex.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  VendorIndex as default
};
