...
function SdgTable({ sdgs }) {
  ...
  return /* @__PURE__ */ jsxs(Table, { children: [
    /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
      ...
      /* @__PURE__ */ jsx(TableHead, { children: "Desc" }),
      /* @__PURE__ */ jsx(TableHead, { children: "Created" }),
      /* @__PURE__ */ jsx(TableHead, {})
    ] }) }),
    /* @__PURE__ */ jsx(TableBody, { children: sdgs.map((sdg) => /* @__PURE__ */ jsxs(TableRow, { children: [
      /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Image, { src: `/storage/sdgs/${sdg.image}`, alt: sdg.name, className: "w-40 bg-gray-300 dark:bg-transparent p-5 rounded-lg object-cover" }) }),
      /* @__PURE__ */ jsx(TableCell, { children: truncateString(sdg.name, 40) }),
      /* @__PURE__ */ jsx(TableCell, { children: truncateString(sdg.description, 40) }),
      /* @__PURE__ */ jsx(TableCell, { children: formatDate(sdg.created_at) }),
      /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        ...
        /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", className: "w-48", children: [
          ...
          /* @__PURE__ */ jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: route("admin.sdgs.edit", [sdg]), children: "Edit" }) }),
