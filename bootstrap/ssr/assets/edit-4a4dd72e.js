...
function PartnerEdit() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Partner" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Edit Partner" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Edit the existing partner" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: route("admin.partners.index"), className: buttonVariants({ variant: "default" }) + " ml-2", children: "Cancel" })
        ] })
      ] }) })
    ] }) })
  ] });
}
PartnerEdit.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  PartnerEdit as default
};
