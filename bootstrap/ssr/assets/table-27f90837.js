...
function ExpertTable({ experts }) {
  ...
  return /* @__PURE__ */ jsxs(Table, { children: [
    ...
    /* @__PURE__ */ jsx(TableBody, { children: experts.data.map((expert) => /* @__PURE__ */ jsxs(TableRow, { children: [
      /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Image, { src: `/storage/experts/${expert.image}`, alt: expert.name, className: "w-14 bg-gray-300 dark:bg-transparent p-5 rounded-lg object-cover" }) }),
