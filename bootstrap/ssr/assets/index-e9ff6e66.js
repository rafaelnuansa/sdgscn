...
import { IconDownload, IconDotsVertical } from "@irsyadadl/paranoid";
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { className: "border-b", children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Bookings" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Manage all bookings" })
      ] }),
      /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex p-5 flex-col gap-3 lg:flex-row", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex gap-3", children: /* @__PURE__ */ jsxs(Select, { value: params == null ? void 0 : params.status, onValueChange: (e) => setParams({ ...params, status: e }), children: [
            ...
            /* @__PURE__ */ jsxs(SelectContent, { children: [
              ...
              /* @__PURE__ */ jsx(SelectItem, { value: "canceled", children: "Canceled" }),
              /* @__PURE__ */ jsx(SelectItem, { value: "completed", children: "Completed" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx(Button, { asChild: true }),
        ...
        /* @__PURE__ */ jsxs(Table, { children: [
          ...
          /* @__PURE__ */ jsx(TableBody, { children: bookings.map((booking) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
            /* @__PURE__ */ jsxs(TableRow, { children: [
              /* @__PURE__ */ jsx(TableCell, { children: booking.invoice }),
              /* @__PURE__ */ jsx(TableCell, { children: booking.user.name }),
              ...
              /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
                ...
                /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", className: "w-48", children: [
                  ...
                  auth.user.is_admin && /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: route("admin.bookings.show", booking.invoice), children: "Show" }) }),
