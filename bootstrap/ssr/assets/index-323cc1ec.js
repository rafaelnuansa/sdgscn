...
import ExpertTable from "./table-27f90837.js";
...
function ExpertsIndex({ auth, ...props }) {
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "p-0 [&_td]:whitespace-nowrap [&_td]:px-6 [&_th]:px-6 [&_thead]:border-t", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between gap-y-6 p-6 md:flex-row md:items-center md:gap-y-0", children: [
          /* @__PURE__ */ jsxs(CardHeader, { className: "p-0", children: [
            /* @__PURE__ */ jsx(CardTitle, { children: "Experts" }),
            /* @__PURE__ */ jsx(CardDescription, { children: "Manage Experts" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex max-w-md flex-col gap-2 md:flex-row", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-x-2 md:flex", children: /* @__PURE__ */ jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxs(Link, { href: route("admin.experts.create"), children: [
              /* @__PURE__ */ jsx(IconCirclePlus, { className: "mr-2 size-4" }),
              "New"
            ] }) }) })
          ] })
        ] }),
        /* @__PURE__ */ jsx(ExpertTable, { experts, handleUserDelete })
      ] }),
      /* @__PURE__ */ jsx(CardFooter, { className: "border-t text-sm text-muted-foreground", children: /* @__PURE__ */ jsx(Pagination, { links: experts.links }) })
    ] }) })
  ] });
}
ExpertsIndex.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  ExpertsIndex as default
};
