    ...
    /* @__PURE__ */ jsxs(Container, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mx-auto lg:py-14", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-12", children: [
          researches.data.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-6", children: researches.data.map((item) => /* @__PURE__ */ jsxs("div", { className: "p-4 bg-gray-100 rounded-lg", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex justify-center py-4", children: /* @__PURE__ */ jsx(Pagination, { links: researches.links }) })
        ] })
      ] })
    ] })
  ] });
