...
function ExpertsCreate() {
  const { data, setData, post, errors, processing } = useForm({
    ...
    link: ""
    // Tambahkan kolom link di form data
  });
  function onChange(e) {
  ...
  const handleSubmit = (e) => {
    ...
    post(route("admin.experts.store"), formData);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Expert" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Create Expert" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Create a new expert" })
      ] }),
...
ExpertsCreate.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  ExpertsCreate as default
};
