...
function PackageIndex() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Header, { title: "Packages", subtitle: "All packages" }),
    /* @__PURE__ */ jsxs(Container, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mx-auto  lg:py-14", children: /* @__PURE__ */ jsx("div", { className: "grid gap-10 md:grid-cols-12", children: /* @__PURE__ */ jsxs("div", { className: "md:col-span-12", children: [
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: packages.data.length > 0 ? packages.data.map((paket) => /* @__PURE__ */ jsx(PackageCard, { paket }, paket.id)) : /* @__PURE__ */ jsx("p", { children: "No Packages found." }) }),
        /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(Pagination, { links: packages.links }) })
      ] }) }) })
    ] })
  ] });
}
PackageIndex.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { children: page });
export {
  PackageIndex as default
};
