...
function ExpertEdit() {
  ...
  const handleSubmit = (e) => {
    ...
    post(route("admin.experts.update", expert.id), formData);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Expert" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Edit Expert" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Edit the existing expert" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: route("admin.experts.index"), className: buttonVariants({ variant: "default" }) + " ml-2", children: "Cancel" })
        ] })
      ] }) })
    ] }) })
  ] });
}
ExpertEdit.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  ExpertEdit as default
};
