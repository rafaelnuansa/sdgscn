...
function SlidersCreate() {
  ...
  const handleSubmit = (e) => {
    ...
    post(route("admin.sliders.store"), formData);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Slider" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Create Slider" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Create a new slider" })
      ] }),
...
SlidersCreate.layout = (page) => /* @__PURE__ */ jsx(AdminLayout, { children: page });
export {
  SlidersCreate as default
};
