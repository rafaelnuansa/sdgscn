...
import { IconAccessible, IconAlbum, IconBag, IconBarsThree, IconBook, IconBookmark, IconBrandApple, IconBuilding, IconCirclePerson, IconDashboard, IconGallery, IconHome3, IconInvoice, IconNotepad, IconPaper, IconPerson, IconPriceTag, IconSettings, IconSketchbook, IconVideoPlaylist } from '@irsyadadl/paranoid'; // Ensure you have these icons available
