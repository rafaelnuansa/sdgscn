...
export const navLinks = [
    ...
    { label: 'SGDs', route: 'admin.sdgs.index', icon: <IconNotebookCover /> },
    { label: 'Research', route: 'admin.research.index', icon: <IconNotebookCover /> },
    { label: 'Publications', route: 'admin.publications.index', icon: <IconNotebookCover /> },
